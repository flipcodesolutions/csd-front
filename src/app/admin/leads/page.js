                  ...
                  filteredLeads.map((lead, index) => {
                    ...
                    return (
                      <tr key={lead.id} className={isSelected ? "selected-row" : ""}>
                        ...
                        <td>
                          <div>
                            <div className="text-white fw-semibold">{lead.model_variant}</div>
            ...
            >
              ...
              <form onSubmit={handleAddSubmit}>
                <div className="modal-body-custom py-3">
                  ...
                  <h6 className="text-white fw-bold mb-3 pb-1 border-bottom border-secondary">
                    1. Customer Details
                  </h6>
                  ...
                  <div className="row g-3 mb-3">
                    ...
                    <div className="col-md-4">
                      <label className="form-label text-white fw-bold small">State</label>
                      <input
                        type="text"
                        className="form-control"
                  ...
                  <h6 className="text-white fw-bold mb-3 pb-1 border-bottom border-secondary mt-4">
                  ...
                  <div className="mb-3">
                    ...
                    >
                      <div className="form-check mb-0">
                        ...
                        />
                        <label className="form-check-label text-white small" htmlFor="addSeg2W">
                      ...
                      <div className="form-check mb-0">
                        <input
                          ...
                          onChange={(e) => setFormData({ ...formData, vehicle_segment: e.target.value })}
                        />
                        <label className="form-check-label text-white small" htmlFor="addSeg4W">
                  ...
                  <div className="row g-3 mb-3">
                    <div className="col-md-6">
                      <label className="form-label text-white fw-bold small">Brand Name</label>
                      <select
                  ...
                  <div className="row g-3">
                    <div className="col-md-4">
                      <label className="form-label text-white fw-bold small">Lead Source</label>
                      <select
                        className="form-select"
                    ...
                    <div className="col-md-4">
                      <label className="form-label text-white fw-bold small">Lead Status</label>
                      <select
                        className="form-select"
                    ...
                    {/* <div className="col-md-4">
                      <label className="form-label text-white fw-bold small">Assigned Executive</label>
                      <select
                        className="form-select"
              ...
              <form onSubmit={handleEditSubmit}>
                <div className="modal-body-custom py-3">
                  ...
                  <div className="row g-3 mb-3">
                    ...
                    <div className="col-md-6">
                      <label className="form-label text-white fw-bold small">Lead Priority</label>
                      <select
                        className="form-select"
                    ...
                    <div className="col-md-6">
                      <label className="form-label text-white fw-bold small">Purchase Timeline</label>
                      <select
                        className="form-select"
            ...
            <div className="modal-dialog-custom" onClick={(e) => e.stopPropagation()} style={{ maxWidth: "560px" }}>
              ...
              <div className="modal-body-custom py-3">
                <div className="d-flex align-items-center justify-content-between mb-3 pb-2 border-bottom border-secondary">
                  <div>
                    <h5 className="text-white fw-bold mb-0">{viewLead.name}</h5>
                ...
                <div className="row g-2 mb-3">
                  <div className="col-6">
                    ...
                    <strong className="text-white">{viewLead.phone}</strong>
                  </div>
                  <div className="col-6">
                    <span className="text-muted small d-block">Email Address</span>
                    <strong className="text-white">{viewLead.email || "N/A"}</strong>
                  </div>
                  ...
                  <div className="col-6 mt-2">
                    ...
                    <strong className="text-white">{viewLead.assigned_to_display || viewLead.assigned_user?.name || viewLead.assigned_user_name || "-"}</strong>
                  </div>
                  <div className="col-6 mt-2">
                    <span className="text-muted small d-block">Assigned By</span>
                    <strong className="text-white">{viewLead.assigned_by_display || viewLead.assigned_by_user?.name || "-"}</strong>
                  </div>
                </div>
                ...
                <div className="mt-4 pt-3 border-top border-secondary">
                  <div className="d-flex align-items-center justify-content-between mb-2">
                    <h6 className="text-white fw-bold mb-0 small">
